...
import com.example.studentmanager.adapter.StuAdapter
import com.example.studentmanager.databinding.FragmentAddStudentBinding
import com.example.studentmanager.databinding.FragmentListBinding
...
class ListFragment : Fragment() {
    ...
    private lateinit var studentArrayList: ArrayList<StudentModel>
    ...
    private fun innitUI() {
        studentRecyclerView = binding.listViewCycle
        studentRecyclerView.layoutManager = LinearLayoutManager(activity)
        studentRecyclerView.setHasFixedSize(true)
        studentArrayList = arrayListOf<StudentModel>()
        getDataFirebase()
    }
        ...
        dbRef.addValueEventListener(object : ValueEventListener{
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                if (snapshot.exists()) {
                    ...
                    studentRecyclerView.adapter = StuAdapter(studentArrayList)
